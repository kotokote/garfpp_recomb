  ...
  for gas in gases:
   for electricField in electricFields:
    for pressure in pressures:
     for angle in angles:
      jobName = 'example_' + pressure + 'atm_' + gas + '_' + electricField + 'Vcm_' + energy + '_' + time + 'ns_0.1R_ftf10_nullon_deBv2_' + angle + 'deg_' + cloudSize + 'elx' + numClouds + '_movie.' + movieframes + '_' + str(batch) + '_' + version
      bashFileName = bashDirectory + '/' + jobName + '.pbs'
      if (energy == '0.025eV'):
       command = EXAMPLE + ' ' + electricField + ' ' + numClouds + ' ' + cloudSize + ' ' + time + ' 0.025 ' + pressure + ' ' + angle + ' 1 ' + gas + ' none ' + movieframes + ' ' + iondistmult
      if (energy == '0.5eV'):
       command = EXAMPLE + ' ' + electricField + ' ' + numClouds + ' ' + cloudSize + ' ' + time + ' 0.5 ' + pressure + ' ' + angle + ' 1 ' + gas + ' none ' + movieframes + ' ' + iondistmult
      if (energy == '0to7eVfcn'):
       command = EXAMPLE + ' ' + electricField + ' ' + numClouds + ' ' + cloudSize + ' ' + time + ' 0 ' + pressure + ' ' + angle + ' 1 ' + gas + ' none ' + movieframes + ' ' + iondistmult
